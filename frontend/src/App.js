...
import DeckComponent from './pages/words/components/Deck';
import FlashcardComponent from './pages/words/components/Flashcard';
...
function App() {
  return (
    <BrowserRouter>
      ...
      <Route path={Routes.findFlashcard} component={FlashcardComponent} />
